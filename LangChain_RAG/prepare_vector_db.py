from langchain.text_splitter import RecursiveCharacterTextSplitter , CharacterTextSplitter #Cắt du liệu
from langchain_community.document_loaders import PyPDFLoader , DirectoryLoader #Làm việc với pdf ..., Direc... để scan toàn bộ thư mục data
from langchain_community.vectorstores import  FAISS #Lưu vector db
...
#Khai báo biến
pdf_data_path = "data"
vectors_db_path = "vectostores/db_faiss"
...
def create_db_from_text():
    ...
    text_splitter = CharacterTextSplitter(
        separator="\n", #cách chia khi xuống dòng
        chunk_size=512, #mỗi đoạn 512 kí tự
        chunk_overlap=50, #overlap quan hệ các đoạn đoạn 1 từ 1-> 512 - đoạn 2 cắt từ 462 đến 974
        length_function=len #độ dài text
    ...
    # Embedding -> all MiniLM-L6 là tập của GPT dùng để train
    embedding_model = GPT4AllEmbeddings(model_file="models/all-MiniLM-L6-v2-f16.gguf")


    #Đưa vào  file Faiss Vector db

    db = FAISS.from_texts(texts=chunks, embedding=embedding_model)


    #Lưu vectorstores
    db.save_local(vectors_db_path)
    return db
